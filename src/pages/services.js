...
export default function ServicesPage() {
    const descriptions = {
        ...
        <p>The above are considered the holy trinity for creating web content.  I am also skilled in the following additional tools: </p>
        <p>
        <ul class="list-group list-group-flush">
        ...
        <h4>"I don't know what most/any of that means....."</h4>
        <p>
    ...
    return (
        <Layout>
            <div className="container">
                ...
                <p>This is a difficult question to answer without knowing the workload for your project.  Please visit the <Link to="/contact">Contact</Link> page and complete the form.  Please include the following details....</p>
                <p>
                    <ul>
