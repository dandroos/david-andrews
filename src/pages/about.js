...
const AboutPage = props => (
  <Layout>
    ...
    <div className="container">
      ...
      <p className="lead">
        Before you decide to hire me for your project, you probably want to know
      ...
      <p>
        I learned to code over a period of a few years of intense studying, lots
        of trial and error, eureka moments and mule-like stubborness! Writing
        code may not be everyone's cup of tea, but I find it a very meditative
        and creative process. The learning journey never ends, which I love!
      </p>
      <p>
        When I'm not sitting/standing in front of my computer (which doesn't
        leave much time!), I volunteer at my local dog rescue shelter. I enjoy
        showing them love and taking them for walks. My favourite breed of dog
        is called a bardino (AKA{" "}
        <a
        ...
        ), which is native to Fuerteventura. It is my ambition to live in a home
        full of them one day!
      </p>
      ...
      <p>
        I also enjoy improving my Spanish (hablo un poco pero lo intento!),
        playing my piano and riding my bike around the beautiful mountainous
        landscape here.
      </p>
      <div className="row">
        <div className="mb-3 col-sm">
      ...
      <div className="mb-6">
        ...
        <p className="lead">
          As a professional developer, I keep the following principles in mind
          at all times...
        </p>
