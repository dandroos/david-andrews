...
const AboutPage = () => (
  <Layout>
      <div className="container">
        ...
        <p>
          I am originally from England but now I live in <a href="https://en.wikipedia.org/wiki/Fuerteventura" target="_blank">Fuerteventura</a>, one of the Canary Islands.  I am kind of a <a href="https://en.wikipedia.org/wiki/Digital_nomad" target="_blank">digital nomad</a>!
        </p>
        <p>
          I learned to code over a period of a few years of intense studying, lots of trial and error and mule-like stubborness! Many people find it hideously boring, but I find it a very meditative and creative process.  The learning journey never ends, which I love!
        </p>
        <p>
          When I'm not sitting/standing in front of my computer (which doesn't leave much time!), I volunteer at my local dog rescue shelter.  I enjoy showing them love and taking them for walks.  My favourite breed of dog is called a bardino (AKA <a href="https://en.wikipedia.org/wiki/Perro_Majorero" target="_blank">perro majorero</a>), which is native to Fuerteventura.  It is my ambition to live in a home full of them one day!
        </p>
